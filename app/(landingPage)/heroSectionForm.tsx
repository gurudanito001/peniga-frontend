    ...
    return(
      <form className="mt-5 max-w-2xl">
          <div className="flex items-center py-3 px-2 md:px-5 bg-neutral-300 text-neutral-800 md:text-lg font-semibold rounded-lg">
            <span>I&apos;m</span>
            <select className="select select-sm w-full max-w-24 sm:max-w-32 border-none appearance-none ring-0 focus:ring-0 bg-neutral-300  md:text-lg font-semibold">
              <option>Buying</option>
              <option>Selling</option>
            </select>
            <div className="divider divider-horizontal divider-neutral mx-1"></div>
            <select className="select select-sm w-full max-w-md border-none appearance-none ring-0 focus:ring-0 bg-neutral-300 md:text-lg font-semibold">
          ...
          <button className="btn btn-lg h-16 mt-4 btn-wide bg-indigo-700">Get Started Now</button>
        </form>
    )
}
