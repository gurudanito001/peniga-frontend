...
const Home = () => {
  ...
  return (
    ...
    <section className="flex flex-col text-neutral h-screen bg-[#E8F5E9] md:px-6 overflow-y-auto">
      ...
      <div className="border-b border-gray-300 w-full mb-5 md:mb-0"></div>
      <div className="">
        <h2 className="text-lg font-semibold mb-3 px-5 lg:px-0 mt-5">Categories</h2>

        <div className="bg-gray-100 px-4 py-6 rounded-lg max-w-full ">
